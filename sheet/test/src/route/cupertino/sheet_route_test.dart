...
void main() {
  group('CupertinoSheetRoute', () {
    testWidgets('renders', (WidgetTester tester) async {
      ...
      ).push(CupertinoSheetRoute(builder: (context) => Text('Sheet')));
    ...
    testWidgets(
      'animates previous route when using MaterialExtendedPageRoute',
      (WidgetTester tester) async {
        ...
        await tester.pumpAndSettle();
        expect(
          find.byType(CupertinoSheetBottomRouteTransition),
          findsOneWidget,
        );
      },
    );
    ...
    testWidgets(
      'animates previous route when using CupertinoExtendedPageRoute',
      (WidgetTester tester) async {
        await tester.pumpApp(SizedBox());
        final controller = Navigator.of(tester.contextForRootNavigator);
        controller.push(
